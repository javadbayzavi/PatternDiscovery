#pragma checksum "E:\PatternDiscovery\discovery\Views\result\getRankofPatternsInCategory.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "748b470e53e282ffceee659352f4314ed6cc92d9"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"748b470e53e282ffceee659352f4314ed6cc92d9", @"/Views/result/getRankofPatternsInCategory.cshtml")]
...
#line 15 "E:\PatternDiscovery\discovery\Views\result\getRankofPatternsInCategory.cshtml"
   Write(Html.DropDownList("rnkforcategories", null , "Select on of the following categories", new { @class = "formm-control" }));
...
<script>
            ...
            datasets: [
                {
                    ...
                    pointHighlightStroke: 'rgba(60,141,1");
            WriteLiteral(@"88,1)',
                    data: barData
                },
            ]
    ...
    $('#rnkforcategories').change(function () {
        if (this.value)
    ");
            WriteLiteral("        loadRankinCatChart(this.value);\r\n    });\r\n</script>");
        }
